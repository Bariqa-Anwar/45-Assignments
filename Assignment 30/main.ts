/*Q 30: Hello Admin: Make a array of five or more usernames, including the name 'admin'. Imagine you are writing code that 
...
let usernames: string [] = ["'Sophia'" , "'Kylie'" , "'Admin'" , "'Eric'"];
