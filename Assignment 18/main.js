...
let my_places = ["'Norhthern Pakistan'", "'Turkey'", "'Italy'", , "'Skardu'", "'Indonesia'"];
...
//again priniting original array
console.log('original: ' + my_places);
//reversing list's order
console.log(`copy: ` + [...my_places].sort().reverse().reverse());
